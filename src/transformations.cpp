...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        */
        ...
        float sca = abs(sin((float)glfwGetTime()));
        transform_2 = glm::scale(transform_2, glm::vec3(sca, sca, sca));

        ourShader.use();
        unsigned int transformLoc_2 = glGetUniformLocation(ourShader.ID, "transform");
        glUniformMatrix4fv(transformLoc_2, 1, GL_FALSE, glm::value_ptr(transform_2));
